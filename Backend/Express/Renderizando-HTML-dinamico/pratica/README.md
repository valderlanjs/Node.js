Criar uma aplicação Node.js usando Express e EJS para cadastro e visualização de uma lista de e-mails de uma newsletter fictícia. A aplicação deve ter três páginas:
